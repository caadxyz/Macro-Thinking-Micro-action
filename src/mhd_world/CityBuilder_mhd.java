...
public class CityBuilder_mhd extends ApplicationTemplate
{
    ...
    // from Ma Haidong
    // some question about this class :
    //  1) about the key and value
    ...
    protected static class AirspaceBuilderModel extends AbstractTableModel
    {
        ...
        //(Iterable<? extends AirspaceEntry> entries) 
    ...
    protected static class PolygonAirspaceFactory implements AirspaceFactory
    {
        ...
        public Airspace createAirspace(WorldWindow wwd, boolean fitShapeToViewport)
        {
            ...
            //set up the the display_name of the class polygon
    ...
    protected static class AirspaceBuilderPanel extends JPanel
    {
        ...
        private void initComponents(AirspaceBuilderModel model, final AirspaceBuilderController controller)
        {
            ...
            JPanel newShapePanel = new JPanel();
            {
                ...
                //by ma haidong
                //events  action and listener which can affect in newShapeButton.
    ...
    protected static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        {   
            ...
            btn.setToolTipText("Creat a City");
        ...
        private class EnableSelectorAction extends AbstractAction
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
            	...
            	builderController.app.getWwd().addSelectListener(new SelectListener()
                {
                    private BasicDragger dragger = new BasicDragger(builderController.app.getWwd());
            	...
            	G_City_Frame g_city_frame=new G_City_Frame(builderController.app.getWwd(),getLayerPanel());
            	
            	g_city_frame.createAndShowGUI();
    ...
    {
        ApplicationTemplate.start("G CITY", AppFrame.class);
    }
}
