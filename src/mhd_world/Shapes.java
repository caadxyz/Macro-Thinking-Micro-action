...
public class Shapes
{
    ...
    protected static class AppFrame extends JFrame
    {
        ...
        public AppFrame()
        {
            ...
            // one  shapes panel to let the user to choose. (by mhd) 
            JPanel shapesPanel = makeShapeSelectionPanel();
            shapesPanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));

           // one  attribute panel to let the user to change the attribute of the shape. (by mhd)
...
//                                AppFrame.this.highlight(pol.getTopObject());
    ...
    private static final String APP_NAME = "World Wind Shapes ETH";
