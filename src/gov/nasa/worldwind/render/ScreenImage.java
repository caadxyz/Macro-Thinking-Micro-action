 ...
 *
 * @author tag
 * @version $Id: ScreenImage.java 12721 2009-10-14 19:57:40Z tgaskins $
 */
public class ScreenImage implements Renderable, Pickable
{
    ...
    /**
     * Returns the layer to be associated with the screen image when the image is picked.
     *
     * @return the layer to associate with the screen image when the image is picked.
     */
    ...
    /**
     * Specifies the layer to be associated with the screen image when the image is picked.
     *
     * @param client the layer to associate with the screen image when the image is picked. May be null.
     */
    public void setClientLayer(Layer client)
    {
        this.clientLayer = client;
    }
    ...
    private void draw(DrawContext dc)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                this.pickSupport.resolvePick(dc, dc.getPickPoint(), this.clientLayer);
            }
        }
        finally
        {
