 ...
 */
public class BasicSurfaceControlPointRenderer implements SurfaceControlPointRenderer
{
    ...
    public BasicSurfaceControlPointRenderer(Marker controlPointMarker)
    {
    ...
    public BasicSurfaceControlPointRenderer()
    {
    ...
    public void render(DrawContext dc, Iterable<? extends SurfaceControlPoint> controlPoints)
    {
        if (dc == null)
        {
    ...
    public void pick(DrawContext dc, Iterable<? extends SurfaceControlPoint> controlPoints, Point pickPoint,
        Layer layer)
    {
        if (dc == null)
        {
    ...
    protected void draw(DrawContext dc, Iterable<? extends SurfaceControlPoint> controlPoints)
    {
        this.begin(dc);
        try
        {
    ...
    protected void drawControlPoints(DrawContext dc, Iterable<? extends SurfaceControlPoint> controlPoints)
    {
        // Render the control points from back-to front.
        SortedSet<SurfaceControlPoint> sortedPoints = this.sortControlPoints(dc, controlPoints);
    ...
    protected void drawMarkers(DrawContext dc, Iterable<? extends SurfaceControlPoint> controlPoints)
    {
    ...
    protected void drawMarker(DrawContext dc, SurfaceControlPoint controlPoint)
    {
    ...
    protected double computeMaxMarkerSize(Iterable<? extends SurfaceControlPoint> controlPoints)
    {
        ...
        for (SurfaceControlPoint p1 : controlPoints)
        {
            for (SurfaceControlPoint p2 : controlPoints)
            {
                if (p1 != p2)
                {
    ...
    protected SortedSet<SurfaceControlPoint> sortControlPoints(DrawContext dc,
        Iterable<? extends SurfaceControlPoint> unsortedPoints)
    {
        ...
        TreeSet<SurfaceControlPoint> set = new TreeSet<SurfaceControlPoint>(new Comparator<SurfaceControlPoint>()
        {
            public int compare(SurfaceControlPoint p1, SurfaceControlPoint p2)
            {
        ...
        for (SurfaceControlPoint p : unsortedPoints)
        {
            set.add(p);
        }
