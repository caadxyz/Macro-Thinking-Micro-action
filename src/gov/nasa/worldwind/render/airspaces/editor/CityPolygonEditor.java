...
import gov.nasa.worldwind.render.city.CityPolygon;
 ...
 */
public class CityPolygonEditor extends AbstractAirspaceEditor
{
    private CityPolygon polygon; // Can be null
    //private CityPolygon polygon; // Can be null
    private static final double DEFAULT_POLYGON_HEIGHT = 10.0;

    public CityPolygonEditor(AirspaceControlPointRenderer renderer)
    {
        super(renderer);
    }

    public CityPolygonEditor()
    {
    }
    ...
    public void setPolygon(CityPolygon airspace)
    {
        this.polygon = airspace;
    }
