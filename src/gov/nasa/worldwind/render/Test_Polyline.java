...
public class Test_Polyline extends AVListImpl implements Renderable, Movable, Restorable
{
    ...
    public Test_Polyline(Iterable<? extends Position> positions)
    {
    ...
    public Test_Polyline(Iterable<? extends LatLon> positions, double elevation)
    {
