...
import javax.swing.border.CompoundBorder;
	...
	//**************************************************************//
	public class ActivityBuilderPanel  extends JPanel{

	        private  JComboBox factoryComboBox;
		    private  JTable entryTable;
		    private  JSpinner sp;
		    private  MarkerBuilderModel model;
		    private  CityBuilderController controller;
		    
		    private boolean ignoreSelectEvents = false;
		    
		    public ActivityBuilderPanel(MarkerBuilderModel ppBuilderModel, CityBuilderController controller)
		    {   this.model=ppBuilderModel;
		        this.controller=controller;
		        this.initComponents(ppBuilderModel, controller);
		...
		public String getSelectedFactory()
		    ...
		    private void initComponents(MarkerBuilderModel ppBuilderModel, final CityBuilderController controller)
		    {
		        final JCheckBox resizeNewShapesCheckBox;
		        final JCheckBox enableEditCheckBox;

		        JPanel newShapePanel = new JPanel();
		        TitledBorder b = BorderFactory.createTitledBorder("Activity Attributes");
		        newShapePanel.setBorder(new CompoundBorder(b, BorderFactory.createEmptyBorder(10, 10, 10, 10)));
		        {
		            ...
		            newShapeButton.setActionCommand(CityBuilder.NEW_ACTIVITY);
		            newShapeButton.addActionListener(controller);
		            newShapeButton.setToolTipText("Create a new marker centered in the viewport");
	                String type[]={"People","Goods","Events"};
		            this.factoryComboBox = new JComboBox(type);
		            this.factoryComboBox.setEditable(false);
		            this.factoryComboBox.setToolTipText("Choose activity type to create");

		            resizeNewShapesCheckBox = new JCheckBox("Fit new activities to viewport");
		            ...
		            resizeNewShapesCheckBox.setToolTipText("New activities are sized to fit the geographic viewport");

		            enableEditCheckBox = new JCheckBox("Enable activity editing");
		            enableEditCheckBox.setActionCommand(CityBuilder.ENABLE_EDIT_ACTIVITY);
		            enableEditCheckBox.addActionListener(controller);
		            enableEditCheckBox.setSelected(controller.isPgEnableEdit());
		        ...
		        {
		            this.entryTable = new JTable(ppBuilderModel);
		            ...
		            this.entryTable.getSelectionModel().addListSelectionListener(new ListSelectionListener()
		            {
		                public void valueChanged(ListSelectionEvent e)
		                {
		                    ...
		                    {
		                        controller.actionPerformed(new ActionEvent(e.getSource(), -1, CityBuilder.SELECTION_CHANGED_PP));
		                    }
		                }
		            });
		        ...
		        JPanel selectionPanel = new JPanel();
		        {
		            ...
		            delselectButton.setActionCommand(CityBuilder.CLEAR_SELECTION_PP);
		            delselectButton.addActionListener(controller);
		            delselectButton.setToolTipText("Clear the selection");

		            JButton deleteButton = new JButton("Delete Selected");
		            deleteButton.setActionCommand(CityBuilder.REMOVE_SELECTED_PP);
		        ...
		        controller.addPropertyChangeListener(new PropertyChangeListener()
		        {
		            public void propertyChange(PropertyChangeEvent e)
		            {
		                ...
		                if (e.getPropertyName() == CityBuilder.SIZE_NEW_SHAPES_TO_VIEWPORT)
		                {
		                    ...
		                    if (e.getPropertyName() == CityBuilder.ENABLE_EDIT_ARCHITECTURE)
		                {
		                    enableEditCheckBox.setSelected(controller.isPgEnableEdit());
		                }
		            }
