...
public class ApplicationTemplate
{
    ...
    {
        private Dimension canvasSize = new Dimension(1030, 830);
        ...
        protected void initialize(boolean includeStatusBar, boolean includeLayerPanel, boolean includeStatsPanel)
        {
            ...
            if (includeLayerPanel)
            {
               ...
               /*
                ...
                splitPane.setLeftComponent(this.layerPanel);
            ...
            else if (includeStatsPanel || System.getProperty("gov.nasa.worldwind.showStatistics") != null)
            {
            ...
            else {this.getContentPane().add(wwjPanel, BorderLayout.CENTER);}
