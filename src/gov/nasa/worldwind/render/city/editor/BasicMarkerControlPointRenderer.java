 ...
 */
public class BasicMarkerControlPointRenderer implements MarkerControlPointRenderer
{
    ...
    public BasicMarkerControlPointRenderer(Marker controlPointMarker)
    {
    ...
    public BasicMarkerControlPointRenderer()
    {
    ...
    public void render(DrawContext dc, Iterable<? extends MarkerControlPoint> controlPoints)
    {
        if (dc == null)
        {
    ...
    public void pick(DrawContext dc, Iterable<? extends MarkerControlPoint> controlPoints, Point pickPoint,
        Layer layer)
    {
        if (dc == null)
        {
    ...
    protected void draw(DrawContext dc, Iterable<? extends MarkerControlPoint> controlPoints)
    {
        this.begin(dc);
        try
        {
    ...
    protected void drawControlPoints(DrawContext dc, Iterable<? extends MarkerControlPoint> controlPoints)
    {
        // Render the control points from back-to front.
        SortedSet<MarkerControlPoint> sortedPoints = this.sortControlPoints(dc, controlPoints);
    ...
    protected void drawMarkers(DrawContext dc, Iterable<? extends MarkerControlPoint> controlPoints)
    {
        ...
        for (MarkerControlPoint p : controlPoints)
        {
            this.drawMarker(dc, p);
        }
    }

    protected void drawMarker(DrawContext dc, MarkerControlPoint controlPoint)
    {
    ...
    protected double computeMaxMarkerSize(Iterable<? extends MarkerControlPoint> controlPoints)
    {
        ...
        for (MarkerControlPoint p1 : controlPoints)
        {
            for (MarkerControlPoint p2 : controlPoints)
            {
                if (p1 != p2)
                {
    ...
    protected SortedSet<MarkerControlPoint> sortControlPoints(DrawContext dc,
        Iterable<? extends MarkerControlPoint> unsortedPoints)
    {
        ...
        TreeSet<MarkerControlPoint> set = new TreeSet<MarkerControlPoint>(new Comparator<MarkerControlPoint>()
        {
            public int compare(MarkerControlPoint p1, MarkerControlPoint p2)
            {
        ...
        for (MarkerControlPoint p : unsortedPoints)
        {
            set.add(p);
        }
