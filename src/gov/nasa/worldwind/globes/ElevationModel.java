 ...
 *
 * @author Tom Gaskins
 * @version $Id: ElevationModel.java 13006 2010-01-14 01:39:59Z tgaskins $
 */
public interface ElevationModel extends WWObject, Restorable
{
     ...
     *         currently in memory for the location, and the location is within the elevation model's coverage area,
     *         the elevation model's minimum elevation at that location is returned.
     */
    double getUnmappedElevation(Angle latitude, Angle longitude);

    /**
     * Returns the elevations of a collection of locations. Maps any elevation values corresponding to the missing
     * data signal to the elevation model's missing data replacement value. If a location within the elevation model's
